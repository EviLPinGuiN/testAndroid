...
public class RadiocarbonListActivity extends BaseActivity implements CommonListView<RadiocarbonResponse>,
    ...
    private CommonAdapter<RadiocarbonResponse> mAdapter;
    private RadiocarbonListPresenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.quick_activity_radiocarbon_list, contentFrameLayout);
        ...
        presenter = new RadiocarbonListPresenter(this);
        initRecycler();
        presenter.init(name);
    }
    ...
    private CommonAdapter<RadiocarbonResponse> getAdapter() {
    ...
    @Override
    public void showItems(@NonNull List<RadiocarbonResponse> items) {
        List<RadiocarbonResponse> t = items;
    ...
    @Override
    public void showDetails(RadiocarbonResponse item) {
//        AuthorShowActivity.start(this, item);
    }

    @Override
    public void onItemClick(@NonNull RadiocarbonResponse item) {
